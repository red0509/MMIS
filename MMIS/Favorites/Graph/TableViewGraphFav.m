...
-(void) num:(NSInteger) num document:(HTMLDocument*) home max:(NSInteger) max array:(NSMutableArray*) array{
    ...
    NSNumber *m1 = @([month1.attributes.allValues.firstObject intValue]);
    NSNumber *m2 = @([month2.attributes.allValues.firstObject intValue]);
    NSNumber *m3 = @([month3.attributes.allValues.firstObject intValue]);
    NSNumber *m4 = @([month4.attributes.allValues.firstObject intValue]);
    NSNumber *m5 = @([month5.attributes.allValues.firstObject intValue]);
